...
#lex_output.write("%5d  %5d   %-14s" % (line, col, all_syms[tok]), end='')
    ...
    if tok == tk_Integer:  lex_output.write("   %5d" % (t[3]))#print("   %5d" % (t[3]))
    elif tok == tk_Ident:  lex_output.write("  %s" %   (t[3]))#print("  %s" %   (t[3]))
    elif tok == tk_String: lex_output.write('  "%s"' % (t[3]))#print('  "%s"' % (t[3]))
    else:                  lex_output.write("")#print("")
